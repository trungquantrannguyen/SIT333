...
public class WeatherController {
	 ...
	 * @return
	 */
	public String persistTemperature(int hour, double temperature, String expectedTime) {
	    System.out.println("Temperature: " + temperature + " of hour: " + hour + 
	                     ", saved at " + expectedTime);
	    
	    // sleep a while to simulate a delay (but use the passed-in timestamp)
